...
export const FileTypes = {
   ...
   */
  getType(extension) {
    if (this.image.all.includes(extension))
      return 'image';
    if (this.video.all.includes(extension))
      return 'video';
    if (this.audio.all.includes(extension))
      return 'audio';
    return 'unknown';
  },
  ...
  getDetailedType(extension) {
    if (this.image.standard.includes(extension))
      return 'standard';
    if (this.image.gif.includes(extension))
      return 'gif';
    if (this.image.svg.includes(extension))
      return 'svg';
    if (this.video.common.includes(extension))
      return 'common';
    if (this.video.extended.includes(extension))
      return 'extended';
    if (this.audio.common.includes(extension))
      return 'common';
    return 'unknown';
  },
